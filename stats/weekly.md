...
Week 63:  
`python3.7 convert.py --action=week --param=63`
...
```
Calc Rewards for Week 63
Total Weights at 0.0: 85698
Full Weights: 99862
Loss: 14.18%
```
...
Exported as rewards/week63_per_reward_address.csv

## Rewards, per HN
Exported as rewards/week63_per_hn_address.csv
