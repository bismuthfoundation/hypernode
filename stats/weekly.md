...
Week 51:  
`python3.7 convert.py --action=week --param=51`

```
Week 51
-------------
TS   1566633600
UTC  2019-08-24T08:00:00Z
Round 8866
Slot  0
Last PoS Round 8865
PoW Height 1312763
Real TS 1566633535.27
Next TS 1566633612.08
Balance 24288.232016657945
Balance (int) 24288
```
...
```
Calc Rewards for Week 51
Total Weights at 0.0: 77896
Full Weights: 80145
Loss: 2.81%
```
...
exported as rewards/week51_per_reward_address.csv

## Rewards, per HN
exported as rewards/week51_per_hn_address.csv
