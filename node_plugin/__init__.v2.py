...
LEDBER_DB = False  # Global DB handler
...
def get_db():
    global LEDBER_DB
    if not LEDBER_DB:
        LEDBER_DB = sqlite3.connect(LEDGER_PATH, timeout=10, check_same_thread=False)
    return LEDBER_DB
...
def HN_reg_round(socket_handler, params: list) -> Union[dict, bool]:
